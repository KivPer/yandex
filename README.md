...
### Примечания:
- Убедитесь, что адрес в примерах `http://localhost:8080/api/v1/calculate` соответствует вашему фактическому адресу сервиса.
- Вы можете дополнить README дополнительной информацией о проекте, такой как авторы, лицензия и т.д., если это необходимо.
